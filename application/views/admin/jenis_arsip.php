...
href="<?php echo base_url('admin/delete_jenis_arsip/'.$d->id_jenis_arsip);?>" 
><i class="fa fa-trash fa-sm"></i></a> <a class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"  data-tooltip="tooltip"
  ...
  title="Edit" href="javascript:;"
       data-toggle="modal" data-target="#edit"   
          data-id="<?= $d->id_jenis_arsip ?>"
          data-nama_jenis_arsip="<?= $d->nama_jenis_arsip ?>"
          > 
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalFormTitle">Tambah jenis_arsip</h5>
    ...
    echo form_open('admin/simpan_jenis_arsip'); ?>
                   <div class="form-group">
                        <label for="exampleInputEmail1">Nama Jenis Arsip</label>
                        <input type="text" class="form-control"  name="nama_jenis_arsip" required  >
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalFormTitle">Edit Jenis Arsip</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('admin/update_jenis_arsip'); ?>
                   <input type="hidden" class="form-control" id="id"  name="id_jenis_arsip" required>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Jenis Arsip</label>
                        <input type="text" class="form-control"  name="nama_jenis_arsip" id="nama_jenis_arsip" required >
    ...
    $(document).ready(function() {
        ...
        $('#edit').on('show.bs.modal', function (event) {
            ...
            modal.find('#nama_jenis_arsip').attr("value",div.data('nama_jenis_arsip'));
        });
    });
</script>